...
class E <T extends Number> {	// 모든 타입을 사용할 수 있도록 제네릭을 쓰는데
	// Integer 가 가장 하위 클래스일 경우 굳이 Integer라 쓰지 않고 Number
...
//		(에러 : 숫자타입 아님) E<Boolean> e4 = new E<Boolean>();
		...
		e3.setT((byte)127);	// 리터럴 : 정수 입력시 Java에서 int로 인식해서 더 작은 byte에 대입할 수 없다. 강제 형변환 필요
