...
interface FuncInterface1 {
	// * @FunctionalInterface 를 지정하면, 추상메소드를 2개 이상 정의하면 에러를 발생하게 한다.(없으면 표면적으로 에러 표시가 나지 않음)
	void method();
...
public class LambdaFormat {
	...
	public static void main(String[] args) {
		...
		FuncInterface1 fi1 = () -> System.out.println("자바람다식1");	// 그때그때 메소드를 정의해서 사용한다.
//		FuncInterface1 fi2 = () -> System.out.println("람다식2");
//		FuncInterface1 fi3 = () -> System.out.println("람다식3");
		fi1.method();
