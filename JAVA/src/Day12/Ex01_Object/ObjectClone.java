...
public class ObjectClone {
	...
	public static void main(String[] args) throws CloneNotSupportedException {	// clone 메소드 호출 오류 해결
		Circle circle = new Circle(10, 20, 5);
		Circle copyCircle = (Circle) circle.clone(); // 인스턴스 복제(일일이 게터, 세터로 지정할 필요 없다)
