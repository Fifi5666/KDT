...
public class CalendarEx {
	...
	// 날짜/시간 정보(Calendar)를 출력하는 메소드 // Calendar cal 객체를 매개변수로 받아서 get 메소드 접근
	...
	public static void main(String[] args) {
		...
		// getTineInMillis()	: 날짜를 ms(밀리초) 단위까지 숫자로 반환
		...
		long dDay = (lastT - nowT) / 1000 / 60 / 60 / 24;	// / (1000 * 60 * 60 * 24)
		...
		birth.set(2003, Calendar.NOVEMBER, 24, 0, 0, 0); 		// 생일 지정
