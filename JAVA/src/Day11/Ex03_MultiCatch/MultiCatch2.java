...
public class MultiCatch2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(input1[0] + input1[1]);	// 두 자리 정수가 입력되지 않았을 경우 [1]에 접근할 수 없다.(IndexOutOfBoundsException)
			System.out.println(input2[0] + input2[1]);
			
			int value1 = Integer.parseInt(str1);	// 문자열을 숫자로(제대로 된 문자열이 아니라면 NumberFormatException)
