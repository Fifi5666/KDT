...
public class Ex13_LogicalOperator {
	...
	public static void main(String[] args) {
		...
		// NOT (!)
		// !A			: A가 true면, false / false면 true로 변환
		...
		// 앞의 조건만 봐도 flase라서 굳이 뒤를 연산하지 않는다. (Dead code)
		System.out.println("value1 = " + value1);
		
		int value2 = 3;
		System.out.println(true || ++value2 > 10);
		// 둘 중 하나가 true니까 뒤에는 볼 필요가 없다. 마찬가지로 ++가 실행되지 않았다. (Dead code)
		System.out.println("value2 = " + value2);
		
		// 비트 연산자는 쇼트 서킷이 적용되지 않는다.
		int value3 = 3;
